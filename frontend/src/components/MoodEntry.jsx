...
function MoodEntry({ userId }) {
    ...
    useEffect(() => {
        ...
        if (userId) {
            api.get(`/api/users/${userId}/moods/`)
                .then(res => {
    ...
    const handleDelete = async (moodId) => {
        if (userId && moodId)
            try {
                ...
                setMoodEntries(prevEntries => prevEntries.filter(mood => mood.id !== moodId));
            } catch (error) {
                                ...
                                <table className="table table-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{mood.description ? mood.description : 'No description'}</td>
                                            <td>
                                                <button onClick={() => handleDelete(mood.id)} className="btn btn-secondary">Delete</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
